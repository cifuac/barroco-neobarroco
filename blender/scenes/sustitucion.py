...
S.etiqueta('ej_sdo', '«virilidad»', (FX + 1.5, 0.0, -0.42), clase='sdo')
S.etiqueta('ej_snte1', '«el aguijón del leptosomático macrogenitoma»', (0, -0.3, -0.62), parent=snte1, clase='snte')
S.etiqueta('porro_sdo', 'canal de desagüe', (FX + 1.5, 0.0, -0.42), clase='sdo')
...
S.etiqueta('papaya_sdo', 'fuente', (FX + 1.5, 0.0, -0.42), clase='sdo')
